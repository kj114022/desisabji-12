    ...
    public function run()
    {
        ...
        \DB::table('users')->insert(array (
            ...
            array (
                ...
                'trial_ends_at' => NULL,
                'device_token' => NULL,
                'role_id' => 3, // Assuming this is a manager role
            ),
            2 => 
            array (
                'id' => 3,
                ...
                'trial_ends_at' => NULL,
                'device_token' => NULL,
                'role_id' => 4, // Assuming this is a client role
            ),
            3 => 
            array (
                'id' => 4,
                ...
                'trial_ends_at' => NULL,
                'device_token' => NULL,
                'role_id' => 1, // Assuming this is a test role
            ),
            4 => 
            array (
                'id' => 5,
                ...
                'trial_ends_at' => NULL,
                'device_token' => NULL,
                'role_id' => 5, // Assuming this is a driver role
            ),
            5 => 
            array (
                'id' => 6,
