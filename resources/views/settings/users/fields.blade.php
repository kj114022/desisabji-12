...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
	...
	<!--
    <div class="form-group row ">
        {!! Form::label('mobile', trans("lang.user_mobile"), ['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::text('mobile', null,  ['class' => 'form-control','placeholder'=>  trans("lang.user_mobile_placeholder")]) !!}
            <div class="form-text text-muted">
