            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    @php
                        ...
                        $floatClass = $isRTL ? 'float-sm-left' : 'float-sm-right';
                    @endphp
                    <ol class="breadcrumb {{$floatClass}}">
                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            ...
                            @php
                                ...
                                $marginClass = $isRTL ? 'mr-auto' : 'ml-auto';
                            @endphp
                            <p class="{{$marginClass}} d-flex flex-column {{$textAlign}}">
