...
class ProductRepository extends BaseRepository implements CacheableInterface
{
    ...
    public function groupedByMarkets()
    {
      ...
      public function productByCity($productId,$cityId){
        ...
        $productDetail = Product::join('product_cities', 'product_cities.product_id', '=', 'products.id')->select("product_cities.price as city_price","product_cities.discount_price as city_discount","product_cities.deliverable as city_deliverable", "products.*")
