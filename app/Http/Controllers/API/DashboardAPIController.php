...
class DashboardAPIController extends Controller
{
    ...
    public function __construct(OrderRepositoryInterface $orderRepo, EarningRepositoryInterface $earningRepository, MarketRepositoryInterface $marketRepo, ProductRepositoryInterface $productRepository)
    {
        parent::__construct();
