...
class ProductAPIController extends Controller
{
    ...
    public function __construct(ProductRepository $productRepo, CustomFieldRepository $customFieldRepo, UploadRepository $uploadRepo,FeatureProductsRepository $featureProductsRepo)
    {
        parent::__construct();
    ...
    public function index(Request $request)
    {
        ...
        Log::debug('city for product in product api :: '. $cityId ); 
        try{
