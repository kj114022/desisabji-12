...
class UserAPIController extends Controller
{
    ...
    {
    Log::debug('User Login 2');
        try {
            $this->validate($request, [
                'phone' => 'required',
                'password' => 'required',
            ]);
            if (auth()->attempt(['mobile' => $request->input('phone'), 'password' => $request->input('password')])) {
    ...
    function register(Request $request)
    {
        ...
        try {
            ...
            $otp = $smsController->generateNumericOTP(6,$data['phone']);
            $smsController->sendUserOTPSms($otp,$data['mobile']);
