...
use App\Criteria\Markets\LimitOffsetCriteria;
...
class MarketAPIController extends Controller
{
    ...
    public function __construct(MarketRepositoryInterface $marketRepo, CustomFieldRepositoryInterface $customFieldRepo, UploadRepositoryInterface $uploadRepo, MarketsCityRepositoryInterface $marketsCityRepo)
    {
        parent::__construct();
