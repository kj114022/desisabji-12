...
class MarketController extends Controller
{
    ...
    public function __construct(MarketRepositoryInterface $marketRepo, CustomFieldRepositoryInterface $customFieldRepo, UploadRepositoryInterface $uploadRepo, UserRepositoryInterface $userRepo, FieldRepositoryInterface $fieldRepository)
    {
