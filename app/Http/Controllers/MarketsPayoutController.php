...
class MarketsPayoutController extends Controller
{
    ...
    public function __construct(MarketsPayoutRepositoryInterface $marketsPayoutRepo, CustomFieldRepositoryInterface $customFieldRepo, MarketRepositoryInterface $marketRepo, EarningRepositoryInterface $earningRepository)
    {
