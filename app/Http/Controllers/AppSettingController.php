...
class AppSettingController extends Controller
{
   ...
   // private $langManager;
    ...
    public function __construct(UserRepositoryInterface $userRepo, RoleRepositoryInterface $roleRepo, UploadRepositoryInterface $uploadRepository, CurrencyRepositoryInterface $currencyRepository)
    {
