...
private $marketRepository;
    ...
    public function __construct(EarningRepositoryInterface $earningRepo, CustomFieldRepositoryInterface $customFieldRepo , MarketRepositoryInterface $marketRepo, OrderRepositoryInterface $orderRepository)
    {
