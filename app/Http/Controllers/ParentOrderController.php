...
abstract class ParentOrderController extends Controller
{
     ...
     */
    public function __construct(OrderRepositoryInterface $orderRepo, ProductOrderRepositoryInterface $productOrderRepository, CartRepositoryInterface $cartRepo, PaymentRepositoryInterface $paymentRepo, NotificationRepositoryInterface $notificationRepo, UserRepositoryInterface $userRepository, OrderStatusRepositoryInterface $orderStatusRepository, CouponRepositoryInterface $couponRepository)
    {
