...
class OrderController extends Controller
{
    ...
    public function __construct(OrderRepositoryInterface $orderRepo, CustomFieldRepositoryInterface $customFieldRepo, UserRepositoryInterface $userRepo
        , OrderStatusRepositoryInterface $orderStatusRepo, NotificationRepositoryInterface $notificationRepo, PaymentRepositoryInterface $paymentRepo)
    {
