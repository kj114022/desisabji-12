...
class FavoriteController extends Controller
{
    ...
    public function __construct(FavoriteRepositoryInterface $favoriteRepo, CustomFieldRepositoryInterface $customFieldRepo, ProductRepositoryInterface $productRepo
