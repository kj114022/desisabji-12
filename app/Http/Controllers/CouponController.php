...
class CouponController extends Controller
{
    ...
    public function __construct(CouponRepositoryInterface $couponRepo, CustomFieldRepositoryInterface $customFieldRepo, ProductRepositoryInterface $productRepo
        , MarketRepositoryInterface $marketRepo
        , CategoryRepositoryInterface $categoryRepo , DiscountableRepositoryInterface $discountableRepository)
    {
