...
class ProductController extends Controller
{
    ...
    public function __construct(ProductRepositoryInterface $productRepo, CustomFieldRepositoryInterface $customFieldRepo, UploadRepositoryInterface $uploadRepo
        ...
        try {
            ...
            if (isset($input['image']) && $input['image']) {
                ...
                $mediaItem->copy($product, 'image');
                   $product->product_slug = $product->name;
                $product->meta_keyword = $product->name;
                $product->product_image = $mediaItem->url;
                $product->product_icon = $mediaItem->icon;
                $product->save();
            }
    ...
    public function update($id, UpdateProductRequest $request)
    {
        ...
        try {
            ...
            if (isset($input['image']) && $input['image']) {
                ...
                $product->product_slug = $product->name;
                $product->meta_keyword = $product->name;
                $product->product_image = $mediaItem->thumb;
                $product->product_icon = $mediaItem->icon;
                 $product->save();
            }
