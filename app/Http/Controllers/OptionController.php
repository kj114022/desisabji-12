...
class OptionController extends Controller
{
    ...
    public function __construct(OptionRepositoryInterface $optionRepo, CustomFieldRepositoryInterface $customFieldRepo, UploadRepositoryInterface $uploadRepo
        , ProductRepositoryInterface $productRepo
        , OptionGroupRepositoryInterface $optionGroupRepo)
    {
