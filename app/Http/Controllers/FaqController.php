...
private $faqCategoryRepository;
    ...
    public function __construct(FaqRepositoryInterface $faqRepo, CustomFieldRepositoryInterface $customFieldRepo , FaqCategoryRepositoryInterface $faq_categoryRepo)
    {
