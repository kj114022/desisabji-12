...
class UserController extends Controller
{
    ...
    public function __construct(UserRepositoryInterface $userRepo, RoleRepositoryInterface $roleRepo, UploadRepositoryInterface $uploadRepo,
                                CustomFieldRepositoryInterface $customFieldRepo)
    {
