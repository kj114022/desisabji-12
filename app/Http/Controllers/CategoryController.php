...
private $uploadRepository;
    ...
    public function __construct(CategoryRepositoryInterface $categoryRepo, CustomFieldRepositoryInterface $customFieldRepo , UploadRepositoryInterface $uploadRepo)
    {
    ...
    $mediaItem->copy($category, 'image');
     $category->service_slug = $category->name;
                $category->meta_keyword = $category->name;
                $category->service_icon = $mediaItem->icon;
                $category->save();
}
