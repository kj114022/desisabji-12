...
class GalleryController extends Controller
{
    ...
    public function __construct(GalleryRepositoryInterface $galleryRepo, CustomFieldRepositoryInterface $customFieldRepo, UploadRepositoryInterface $uploadRepo
