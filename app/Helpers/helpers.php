 ...
 * @return string
 */
function getLinksColumn($baseUrl, $idAttribute = 'id', $titleAttribute = 'title',$array = [])
{
 ...
 * @return string
 */
function getLinksColumnByRouteName($routeName, $idAttribute = 'id', $titleAttribute = 'title',$array = [])
{
    $html = '<a href="${href}" class="text-bold text-dark">${title}</a>';
    $result = [];
    foreach ($array as $link) {
...
function getNeededArray($input,$string = '',$delimiter = '|')
{
