...
class Product extends Model implements HasMedia
{
   ...
   /**
    ...
    {
        return $this->options()->get(['id', 'name', 'description', 'price', 'product_id','option_group_id']);
    }
 ...
 */
public function currentPricing($productId,$cityId)
{
    return $this->hasOne(ProductsCity::class)->ofMany([
        'city_id' => $cityId,
...
{
     return $this->hasOneThrough(ProductsCity::class, Cart::class);
}
}
